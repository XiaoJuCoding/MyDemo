...
public class PackageDetail : MonoBehaviour
{
    ...
    private void Test()
    {
        Refresh(GameManager.Instance.GetPackageLocalData()[4], null);
    }

    private void InitUIName()
    {
        UIStars = transform.Find("Center/Star");
    ...
    public void Refresh(PackageLocalItem packageLocalData, PackagePanel uiParent)
    {
        ...
        // 等级
        UILevelText.GetComponent<Text>().text = string.Format("Lv.{0}/80", this.packageLocalData.level.ToString());
        // 简短描述
        ...
        // 图片加载
        Texture2D t = (Texture2D)Resources.Load(this.packageTableItem.iconPath);
